    ...
    def __call__(self, predictions, images_root):
        ...
        for img_name, pred_caption in predictions.items():
            ...
            if score > max_clip_score:
                ...
                max_clip_score_name = img_name
            if score < min_clip_score:
                min_clip_score = score
                min_clip_score_name = img_name

        return total_score / len(predictions), max_clip_score, max_clip_score_name, min_clip_score, min_clip_score_name
...
def main(args):
    ...
    # CLIPScore
    clip_score, max_clip_score, max_clip_score_name, min_clip_score, min_clip_score_name = CLIPScore()(predictions, args.images_root)
    
    print(f"CIDEr: {cider_score} | CLIPScore: {clip_score}")

    print("Max CLIPScore : ", max_clip_score_name, max_clip_score)
    print("Min CLIPScore : ", min_clip_score_name, min_clip_score)
